...
export function startMetrics(playModule: any) {
  ...
  const metrics = { fps: 0, emuSpeedPct: 0, msPerFrame: 0, frameHash: null as number | null, threadsOk, cores, jitCompileMs: 0, jitBlocks: 0, blockDispatches: 0, chainMapEntries: 0, stateHash: 0, stateHashAtN: 0, totalFrames: 0, ts: Date.now() };
